...
var LandingPage = React.createClass({
  ...
  render: function(){
    return (<div className="page1-style">
              <MenuBar />
          ...
          <div className="backdrop">
            <div className="row">
              <div className="column medium-12 ">
                <br /><br />
                <h1 className="center">Rejuvenation Health Club </h1>
                <br />
                <Paragraph className="center tagline" value='Welcome to Rejuvenation. We specialise in MASSAGE, REIKI and ACUPUNCTURE.'/>
                <br /><br /><br />
              </div>
            </div>
            <div className="row">
                <div className="columns medium-12 center">
                    <PpButton clicked={this.bookAnAppointmentClicked} type="button" value="Book an Appointment" className="x-large-button"/>
                    <br />
                </div>
            </div> 
